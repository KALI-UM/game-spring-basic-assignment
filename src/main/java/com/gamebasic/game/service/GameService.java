...
public class GameService {
    ...
    public GameDetailResponse getGame(Long gameId) {
        ...
        List<CardResponse> cards = runCardRepository.findAllByGameOrderByIdAsc(game).stream().map(
                card->new CardResponse(card.getId(), card.getCardType(), card.getAcquiredFloor())).collect(Collectors.toList());
